...
last_scan_time = "Initializing Engine..."
        ...
        <div class="data-card-grid">
            ...
            <div class="token-card">
                <div class="token-header">
                    ...
                    <div class="ai-tag">AI CONFIRM: 88%</div>
                </div>
            ...
            <div class="token-card" style="grid-column: 1 / -1; text-align: center; padding: 3rem;">
                <p style="color: var(--text-muted);">Fetching Live Solana Liquidity Pools...</p>
            </div>
            {% endfor %}
        </div>

        <div class="footer">
            SOLANA QUANT ENGINE v2.4 • HIGH FREQUENCY MEME SCANNER
        </div>
    </div>
</body>
</html>
